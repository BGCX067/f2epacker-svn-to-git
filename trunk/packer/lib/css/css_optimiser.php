...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body onload="enable_disable_preserve()">
    ...
    <?php echo $lang[$l][39]; ?>: <a hreflang="en" href="?lang=en">English</a> <a hreflang="de" href="?lang=de">Deutsch</a> <a hreflang="fr" href="?lang=fr">French</a> <a hreflang="zh" href="?lang=zh">简体</a> <a hreflang="big5" href="?lang=big5">繁体</a></p>
    <p><?php echo $lang[$l][4]; ?>
      <?php echo $lang[$l][6]; ?>
    </p>
    ...
    style="color:red;">'.$ratio.'%</span> ('.$diff.' Bytes)';
        ...
        echo ' - <a href="javascript:ClipBoard()">复制到剪切板</a>';
        echo '</legend>';
